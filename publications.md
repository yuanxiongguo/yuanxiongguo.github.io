...
2. DP-ADMM: ADMM-based Distributed Learning with Differential Privacy  
 Z. Huang, R. Hu, Y. Guo, E. Chan-Tin, and Y. Gong  
 to appear in IEEE Transactions on Information Forensics and Security.  

3. Exploiting Backscatter-Aided Relay Communications with Hybrid Access Model in Device-to-Device Networks  
 S. Gong, L. Gao, J. Xu, Y. Guo, D. Hoang, and D. Niyato  
 to appear in IEEE Transactions on Cognitive Communications and Networking.

4. Data-Driven Spectrum Trading with Secondary Users' Differential Privacy Preservation  
 J. Wang, X. Zhang, Q. Zhang, M. Li, Y. Guo, Z. Feng, and M. Pan  
 to appear in IEEE Transactions on Dependable and Secure Computing. 

5. Beef Up the Edge: Spectrum-Aware Placement of Edge Computing Services for the Internet of Things  
 H. Ding, Y. Guo, X. Li, and Y. Fang  
 to appear in IEEE Transactions on Mobile Computing.  

6. Aggregation-Based Colocation Datacenter Energy Management in Wholesale Markets  
 Y. Guo, M. Pan, and Y. Gong  
 to appear in IEEE Transactions on Cloud Computing.  

7. Dynamic Multi-Tenant Coordination for Sustainable Colocation Data Centers  
 Y. Guo, M. Pan, Y. Gong, and Y. Fang  
 to appear in IEEE Transactions on Cloud Computing.  

8. Colocation Data Center Demand Response using Nash Bargaining Theory  
 Y. Guo, H. Li, and M. Pan  
 IEEE Transactions on Smart Grid, vol. 9, no. 5, pp. 4017-4026, September 2018.  

9. Protecting Operation-Time Privacy of Primary Users in Downlink Cognitive Two-Tier Networks  
 X. Dong, Y. Gong, J. Ma, and Y. Guo  
 IEEE Transactions on Vehicular Technology, vol. 67, no. 7, pp. 6561-6572, July 2018.  

10. Islanding-Aware Robust Energy Management for Microgrids  
 Y. Guo and C. Zhao  
 IEEE Transactions on Smart Grid, vol. 9, no. 2, pp. 1301-1309, March 2018.  

11. Dolphins First: Dolphin-Aware Communications in Multi-hop Underwater Cognitive Acoustic Networks  
 X. Li, M. Pan, Y. Sun, Y. Guo, and X. Fu  
 IEEE Transactions on Wireless Communications, vol. 16, no. 4, pp. 2043-2056, April 2017.  

12. My Privacy My Decision: Control of Photo Sharing on Online Social Networks  
 K. Xu, Y. Guo, L. Guo, Y. Fang, and X. Li  
 IEEE Transactions on Dependable and Secure Computing, vol. 14, no. 2, pp. 199-210, March/April 2017.  

13. M3-STEP: Matching Based Multi-Radio Multi-Channel Spectrum Trading with Evolving Preferences  
 J. Wang, W. Ding, Y. Guo, C. Zhang, M. Pan, and J. Song  
 IEEE Journal on Selected Areas in Communications, vol. 34, no. 11, pp. 3014 - 3024, November 2016. 

14. Optimal Task Recommendation for Mobile Crowdsourcing with Privacy Control  
 Y. Gong, L. Wei, Y. Guo, C. Zhang, and Y. Fang  
 IEEE Internet of Things Journal, vol. 3, no. 5, pp. 745-756, October 2016.  

15. Private Data Analytics on Biomedical Sensing Data via Distributed Computation  
 Y. Gong, Y. Fang, and Y. Guo  
 IEEE/ACM Transactions on Computational Biology and Bioinformatics, vol. 13, no. 3, pp. 431-444, May/June 2016.  

16. A Privacy-Preserving Framework for Incentive-based Demand Response in the Smart Grid  
 Y. Gong, Y. Cai, Y. Guo, and Y. Fang  
 IEEE Transactions on Smart Grid, vol. 7, no. 3 pp. 1304-1313, May 2016.

17. Energy and Network Aware Workload Management for Sustainable Data Centers with Thermal Storage
 Y. Guo, Y. Gong, Y. Fang, P. P. Khargonekar, and X. Geng  
 IEEE Transactions on Parallel and Distributed Systems, vol. 25, no. 8, pp. 2030-2042, August 2014.

18. Decentralized Coordination of Energy Utilization for Residential Households in the Smart Grid  
 Y. Guo, M. Pan, Y. Fang, and P. P. Khargonekar    
 IEEE Transactions on Smart Grid, vol. 4, no. 3, pp. 1341-1350, September 2013.

19. A Market Based Scheme to Integrate Distributed Wind Energy    
 Z. Ding, Y. Guo, D. Wu, and Y. Fang  
 IEEE Transactions on Smart Grid, vol. 4, no. 2, pp. 976-984, June 2013.

1. Electricity Cost Saving Strategy in Data Centers by Using Energy Storage  
 Y. Guo and Y. Fang  
 IEEE Transactions on Parallel and Distributed Systems, vol. 24, no. 6, pp. 1149-1160, June 2013.

1. Optimal Power Management of Residential Customers in the Smart Grid  
 Y. Guo, M. Pan, and Y. Fang  
 IEEE Transactions on Parallel and Distributed Systems, vol. 23, no. 9, pp. 1593-1606, September 2012.  
